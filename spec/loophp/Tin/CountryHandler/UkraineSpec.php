...
class UkraineSpec extends ObjectBehavior
{
    ...
    public function it_should_validate_ukraine_tin(): void
    {
        ...
        $this->validate('1111111111')->shouldThrow(\loophp\Tin\Exception\TINException::class); // All same digits
        $this->validate('0000000000')->shouldThrow(\loophp\Tin\Exception\TINException::class); // All zeros
        $this->validate('123456789')->shouldThrow(\loophp\Tin\Exception\TINException::class); // Too short
        $this->validate('12345678901')->shouldThrow(\loophp\Tin\Exception\TINException::class); // Too long
        $this->validate('123456789a')->shouldThrow(\loophp\Tin\Exception\TINException::class); // Contains letter
        $this->validate('123456789-')->shouldThrow(\loophp\Tin\Exception\TINException::class); // Contains dash
    }
    ...
    public function it_should_validate_checksum(): void
    {
        ...
        $this->validate('5632582744')->shouldThrow(\loophp\Tin\Exception\TINException::class); // Wrong last digit
        $this->validate('2935277369')->shouldThrow(\loophp\Tin\Exception\TINException::class); // Wrong last digit
        $this->validate('5555555556')->shouldThrow(\loophp\Tin\Exception\TINException::class); // Wrong last digit
    }
